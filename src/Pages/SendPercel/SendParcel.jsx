...
const SendParcel = () => {
    ...
    const handleSendParcel = async (data) => {
        ...
        try{
            const result = await axiosSecure.post('/parcel',parcelData);
            const response = result.data
            toast.success('Percel send successfully!')
        }
        catch(er) {
            console.log(er)
        }
            ...
            <form onSubmit={handleSubmit(handleSendParcel)} className=''>
                <div className="percel-category flex gap-4">
                    <label className="label">
                        <input type="radio" {...register('document')} name="radio-1" className="radio radio-secondary" defaultChecked />
                        Document</label>

                    <label className="label">
                        <input type="radio" {...register('non-document')} name="radio-1" className="radio radio-secondary" />
                        Non-Document</label>
                </div>
                ...
                <div className="percel-info grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-5 my-6">
                    <fieldset className="fieldset percel-name">
                        ...
                        <input type="text" {...register('parcelName')} className="input w-full border-secondary " placeholder="Percel Name" />
                    </fieldset>

                    <fieldset className="fieldset percel-weight">
                        <label className="label font-bold text-secondary text-[18px]">Percel Weight</label>
                        <input type="text" {...register('parcelWeigth')} className="input w-full border-secondary " placeholder="Percel Weight(KG)" />
                    </fieldset>
                </div>
                ...
                <div className="percel-details grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-5">
                    <fieldset className="fieldset sender-details">
                        ...
                        <input type="text" {...register('senderName')} className="input w-full border-secondary " placeholder="Sender Name" />

                        <label className="label font-bold text-secondary text-[18px]">Sender Email</label>
                        <input className="input w-full border-secondary" {...register('senderEmail')} placeholder="Sender Email" />


                        <label className="label font-bold text-secondary text-[18px]">Sender Address</label>
                        <input type="text" className="input w-full border-secondary" {...register('senderAddress')} placeholder="Sender Address" />

                        <label className="label font-bold text-secondary text-[18px]">Sender Phone No</label>
                        <input type="text" className="input w-full border-secondary" {...register('senderPhone')} placeholder="Sender Phone No" />

                        <label className="label font-bold text-secondary text-[18px]">Your Region</label>
                        <select {...register('senderRegion')} defaultValue="Select Your Region" className="select w-full border-secondary">
                            <option disabled={true}>Select Your Region</option>

                        </select>

                        <label className="label font-bold text-secondary text-[18px]">Your District</label>
                        <select {...register('senderDistrict')} defaultValue="Select Your District" className="select w-full border-secondary">
                            <option disabled={true}>Select Your District</option>

                        </select>

                        <label className="label font-bold text-secondary text-[18px]">Pickup Instruction</label>
                        <textarea {...register('senderInstruction')} className="textarea w-full border-secondary" placeholder="Pickup Instruction"></textarea>
                    </fieldset>
                    ...
                    <fieldset className="fieldset receiver-details">
                        ...
                        <input type="text" {...register('receiverName')} className="input w-full border-secondary" placeholder="Receiver Name" />

                        <label className="label font-bold text-secondary text-[18px]">Receiver Email</label>
                        <input type="email" {...register('receiverEmail')} className="input w-full border-secondary" placeholder="Receiver Email" />

                        <label className="label font-bold text-secondary text-[18px]">Receiver Address</label>
                        <input type="text" {...register('receiverAddress')} className="input w-full border-secondary" placeholder="Receiver Address" />

                        <label className="label font-bold text-secondary text-[18px]">Receiver Contact No</label>
                        <input type="text" {...register('receiverContact')} className="input w-full border-secondary" placeholder="Receiver Phone No" />

                        <label className="label font-bold text-secondary text-[18px]">Receiver Region</label>
                        <select {...register('receiverRegion')} defaultValue="Select Receiver Region" className="select w-full border-secondary">
                        ...
                        <select {...register('receiverDistrict')} defaultValue="Select Receiver District" className="select w-full border-secondary">
                            <option disabled={true}>Select Receiver District</option>

                        </select>

                        <label className="label font-bold text-secondary text-[18px]">Pickup Instruction</label>
                        <textarea {...register('receiverInstruction')} className="textarea w-full border-secondary" placeholder="Receiver Pickup Instruction"></textarea>
                    </fieldset>
                </div>
